...
SECRET_KEY = 'django-insecure-m!3kduk%gd2p)yh@n$!#pby47s!+@q=-ry8i$%mhb6eh-u2jzo'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'gustavohenriquedasilva66@gmail.com'
EMAIL_HOST_PASSWORD = 'ddrjgwrvkuqayqmo'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'SGIM/static')]
