    ...
    return (
        (n = [
            ...
            function (M, t, e) {
                ...
                class Ln extends m {
                    ...
                    _addTouchEventListeners() {
                        ...
                        this._swipeHelper = new hn(this._element, {
                            leftCallback: () =>
                                this._slide(this._directionToOrder(pn)),
                            rightCallback: () =>
                                this._slide(this._directionToOrder(gn)),
                            endCallback: () => {
                                "hover" === this._config.pause &&
                                    (this.pause(),
                                    this.touchTimeout &&
                ...
                function Fi(t) {
                    return (
                        (Ii(t) ? t.ownerDocument : t.document) ||
                        window.document
                    ).documentElement;
                }
                function qi(t) {
                ...
                function uo(t, e) {
                    ...
                    var n = (function t(e) {
                        ...
                        i = A(n),
                        i = t
                            ? [i].concat(i.visualViewport || [], lo(n) ? n : [])
                            : n,
                        n = e.concat(i);
                ...
                function fo(t, e, n) {
                    return e === gi
                        ...
                        : ho(
                              ...
                              "rtl" === D(l || c).direction &&
                                  (s +=
                                      ji(c.clientWidth, l ? l.clientWidth : 0) -
                                      i),
                ...
                function mo(t, e) {
                    var i,
                        ...
                        c = po(
                            Ii(c)
                                ? c
                                : c.contextElement || Fi(t.elements.popper),
                            r,
                            s,
                            o
                        ),
                        ...
                        w &&
                            (d &&
                                ...
                                (o = m
                                    ...
                                    : _ + l + i + h.mainAxis),
                                (m = (n =
                                    u.elements.arrow && Qi(u.elements.arrow))
                                    ? "y" === b
                                        ? n.clientTop || 0
                                        : n.clientLeft || 0
                                    : 0),
                    ...
                    show() {
                        ...
                        this._elemIsActive(n) ||
                            ((e = (t = this._getActiveElem())
                                ...
                                : null),
                            f.trigger(n, kr, { relatedTarget: t })
                                .defaultPrevented) ||
