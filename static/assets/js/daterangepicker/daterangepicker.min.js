    ...
    (Z.dateRangePickerLanguages = {
        ...
        (Z.fn.dateRangePicker = function (p) {
            p || (p = {}),
                ...
                "auto" == p.singleMonth &&
                    (p.singleMonth = Z(window).width() < 480),
                p.singleMonth && (p.stickyMonths = !1),
                p.showTopbar || (p.autoClose = !0),
                p.startDate &&
                    "string" == typeof p.startDate &&
                    (p.startDate = Q(p.startDate, p.format).toDate()),
                p.endDate &&
                    "string" == typeof p.endDate &&
                    (p.endDate = Q(p.endDate, p.format).toDate()),
                p.yearSelect &&
                ...
                r = (function () {
                    {
                        if ("auto" == p.language) {
                            ...
                            return e &&
                                (e = e.toLowerCase()) in
                                    Z.dateRangePickerLanguages
                                ? Z.dateRangePickerLanguages[e]
                                : Z.dateRangePickerLanguages.default;
                        }
                        return p.language &&
                            p.language in Z.dateRangePickerLanguages
                            ? Z.dateRangePickerLanguages[p.language]
                            : Z.dateRangePickerLanguages.default;
                    }
                })(),
                s = !1,
                    ...
                    Z(this).data("date-picker-opened", !0),
                        (m = (function () {
                            ...
                            var a = p.showWeekNumbers ? 6 : 5,
                                n = "&lt;";
                            p.customArrowPrevSymbol &&
                                (n = p.customArrowPrevSymbol);
                            var r = "&gt;";
                            if (
                                (p.customArrowNextSymbol &&
                            ...
                            if (
                                ...
                                ((t +=
                                    ...
                                    (p.customValueLabel || K("custom-values")) +
                                    "</b>"),
                                p.customValues)
                            )
                                for (
                                    var o = 0;
                                    o < p.customValues.length;
                                    o++
                                ) {
                ...
                if (!p.inline) {
                    ...
                    if ("relative" == Z(p.container).css("position")) {
                        var t = Z(p.container).offset(),
                            a = Math.max(
                                0,
                                e.left + m.outerWidth() - Z("body").width() + 16
                            );
                        m.css({
            ...
            function t(e) {
                B(),
                    ...
                    p.customOpenAnimation
                        ? p.customOpenAnimation.call(m.get(0), function () {
                    ...
                    Z(n).trigger("datepicker-open", { relatedTarget: m }),
                    I(),
                    l(),
                    o();
            }
            function a() {
                ...
                if (t && ((1 == t.length && p.singleDate) || 2 <= t.length)) {
                    ...
                    a.match(/Do/) &&
                        ...
                        2 <= t.length
                            ? T(
                                  d(t[0], a, Q.locale(p.language)),
                                  d(t[1], a, Q.locale(p.language))
                              )
                            : 1 == t.length &&
                              p.singleDate &&
                              C(d(t[0], a, Q.locale(p.language))),
                        (s = !0);
                }
            }
            function d(e, t, a) {
            ...
            function h(e, t) {
                p[e] = parseInt(
                    Q(parseInt(t))
                        .startOf("day")
                        .add(Q(p[e + "Time"]).format("HH"), "h")
                        .add(Q(p[e + "Time"]).format("mm"), "m")
                        .valueOf()
                );
            }
            function c(e, r, s) {
                ...
                if (!e.hasClass("invalid")) {
                    ...
                    if (
                        ...
                        p.singleDate
                            ...
                            ? ((p.start = Q(parseInt(t)).day(1).valueOf()),
                              (p.end = Q(parseInt(t)).day(5).valueOf()))
                            : "weekend" === p.batchMode
                            ? ((p.start = Q(parseInt(t)).day(6).valueOf()),
                              (p.end = Q(parseInt(t)).day(7).valueOf()))
                            : "month" === p.batchMode
                            ? ((p.start = Q(parseInt(t))
                                  .startOf("month")
                                  .valueOf()),
                              (p.end = Q(parseInt(t)).endOf("month").valueOf()))
                    ...
                    (p.start = parseInt(p.start)),
                        ...
                        p.start &&
                            !p.end &&
                            (Z(n).trigger("datepicker-first-date-selected", {
                                date1: new Date(p.start),
                            }),
                            y(e)),
                        w(),
                ...
                return (
                    ...
                    p.start &&
                        ...
                        m.find(".day.toMonth.valid").each(function () {
                            k(parseInt(Z(this).attr("time"), 10))
                                ? Z(this)
                                      .addClass("valid tmp")
                                      .removeClass("invalid")
                                : Z(this)
                ...
                if (e.hasClass("has-tooltip") && e.attr("data-tooltip"))
                    ...
                    if (p.singleDate)
                        ...
                        (m.find(".day").each(function () {
                            ...
                            p.start, p.end;
                            e == t
                                ? Z(this).addClass("hovering")
                                : Z(this).removeClass("hovering"),
                                p.start &&
                                !p.end &&
                                ((p.start < e && e <= t) ||
                                    (p.start > e && t <= e))
                        ...
                        var n = O(t, p.start);
                        p.hoveringTooltip &&
                            ("function" == typeof p.hoveringTooltip
                                ? (a = p.hoveringTooltip(n, p.start, t))
                                : !0 === p.hoveringTooltip &&
                                  1 < n &&
                                  (a = n + " " + K("days")));
                    }
            ...
            function D(e) {
                ...
                s &&
                    o.isSameOrBefore(s) &&
                    (o = s.add("month2" === n ? 1 : 0, "month")),
                    i &&
                        o.isSameOrAfter(i) &&
                        (o = i.add(
                            p.singleMonth || "month1" !== n ? 0 : -1,
                            "month"
                        )),
                    z(o, n),
                    "month1" === n
                        ? (p.stickyMonths ||
                              Q(o).isSameOrAfter(p[r], "month")) &&
                          z(Q(o).add(1, "month"), r)
                        : (p.stickyMonths ||
                              Q(o).isSameOrBefore(p[r], "month")) &&
                          z(Q(o).add(-1, "month"), r),
                    I();
            }
            function x() {
                !0 === p.singleDate
                    ? s && p.start && p.autoClose && N()
                    : s && p.start && p.end && p.autoClose && N();
            }
            function M() {
                ...
                p.singleDate
                    ...
                    ? ((p.start = !1),
                      ...
                      m
                          ...
                          .addClass("error")
                          .find(".error-top")
                          .html(K("less-than").replace("%d", p.maxDays)))
                    ...
                    ? ((p.start = !1),
                      ...
                      m
                          ...
                          .addClass("error")
                          .find(".error-top")
                          .html(K("more-than").replace("%d", p.minDays)))
                    : p.start || p.end
                    ? m
                          .find(".drp_top-bar")
                          .removeClass("error")
                    ...
                    p.batchMode &&
                        ((p.start &&
                            p.startDate &&
                            F(p.start, p.startDate) < 0) ||
                            (p.end && p.endDate && 0 < F(p.end, p.endDate))) &&
                        ((p.start = !1),
                        (p.end = !1),
                        m.find(".day").removeClass("checked"));
            }
            function S(e, t) {
                ...
                m.find(".start-day").html("..."),
                    ...
                    p.start &&
                        m
                            .find(".start-day")
                            .html(W(new Date(parseInt(p.start)))),
                    p.end &&
                        m.find(".end-day").html(W(new Date(parseInt(p.end)))),
            ...
            function T(e, t, a) {
                ...
                var r = !0;
                if (
                    (p.startDate && F(e, p.startDate) < 0 && (r = !1),
                ...
                (p.start = e.getTime()),
                    ...
                    (p.stickyMonths || (0 < F(e, t) && 0 === L(e, t))) &&
                        (p.lookBehind ? (e = R(t)) : (t = H(e))),
                    p.stickyMonths &&
                        !1 !== p.endDate &&
                        0 < L(t, p.endDate) &&
                        ((e = R(e)), (t = R(t))),
            ...
            function C(e) {
                var t = !0;
                if (
                    (p.startDate && F(e, p.startDate) < 0 && (t = !1),
                    ...
                    (m.find(".day").each(function () {
                        ...
                        p.time.enabled &&
                            ...
                            (a = Q(a || Q().valueOf())
                                .startOf("day")
                                .valueOf())),
                            (p.start && p.end && e <= a && t <= e) ||
                            (p.start &&
                                !p.end &&
                                Q(t).format("YYYY-MM-DD") ==
                                    Q(e).format("YYYY-MM-DD"))
                                ? Z(this).addClass("checked")
                                : Z(this).removeClass("checked"),
                            p.start &&
                            Q(t).format("YYYY-MM-DD") ==
                                Q(e).format("YYYY-MM-DD")
                                ? Z(this).addClass("first-date-selected")
                                : Z(this).removeClass("first-date-selected"),
                            p.end &&
                            Q(a).format("YYYY-MM-DD") ==
                                Q(e).format("YYYY-MM-DD")
                                ? Z(this).addClass("last-date-selected")
                                : Z(this).removeClass("last-date-selected");
                    }),
                    m.find(".week-number").each(function () {
                        Z(this).attr("data-start-time") == p.startWeek &&
                            Z(this).addClass("week-number-selected");
                    }));
            }
            function z(e, t) {
                var a = (function (e, t) {
                        ...
                        var r =
                                !!p.startDate &&
                                Q(p.startDate).add(
                                    p.singleMonth || "month2" !== t ? 0 : 1,
                                    "month"
                                ),
                            s =
                                !!p.endDate &&
                                Q(p.endDate).add(
                                    p.singleMonth || "month1" !== t ? 0 : -1,
                                    "month"
                                ),
                    ...
                    n = (function (e, t) {
                        ...
                        var r =
                            ...
                            d = s
                                ? Math.max(o[0], s.get("year"))
                                : Math.min(o[0], a),
                            l = i
                                ? Math.min(o[1], i.get("year"))
                                : Math.max(o[1], a),
                            u = Math.min(d, a),
                            m = Math.max(l, a);
                        if (u === m) return n;
                                ...
                                for (var o = 0; o < 7; o++) {
                                    ...
                                    if (
                                        ...
                                        a.valid &&
                                            p.beforeShowDay &&
                                            "function" ==
                                                typeof p.beforeShowDay)
                                    ) {
                                        var c = p.beforeShowDay(
                                            Q(a.time).toDate()
                                        );
                                        (a.valid = c[0]),
                                            (a.extraClass = c[1] || ""),
                            ...
                            (t = Z(this)),
                                ...
                                p.startWeek
                                    ? (m
                                      ...
                                      (a = new Date(
                                          r < p.startWeek ? r : p.startWeek
                                      )),
                                      (n = new Date(
                                          r < p.startWeek ? p.startWeek : r
                                      )),
                                      (p.startWeek = !1),
                                      (p.start = Q(a)
                                          .day(
                                              "monday" == p.startOfWeek ? 1 : 0
                                          )
                                          .valueOf()),
                                      (p.end = Q(n)
                                          .day(
                                              "monday" == p.startOfWeek ? 7 : 6
                                          )
                                          .valueOf()))
                                    : ((p.startWeek = r),
            ...
            function N() {
                if (!p.alwaysOpen) {
                    ...
                    p.customCloseAnimation
                        ? p.customCloseAnimation.call(m.get(0), e)
                        : Z(m).slideUp(p.duration, e),
                        Z(n).trigger("datepicker-close", { relatedTarget: m });
                }
            }
            function B() {
            ...
            function q(e) {
                return (
                    (e = Q(e)),
                    !(
                        !p.startDate || !e.endOf("month").isBefore(p.startDate)
                    ) || !(!p.endDate || !e.startOf("month").isAfter(p.endDate))
                );
            }
            function $(e, t, r) {
                var s = Z.extend(!0, {}, e);
            ...
            function J(e, t) {
                return p.showDateFilter && "function" == typeof p.showDateFilter
                    ? p.showDateFilter(e, t)
                    : t;
            }
            function K(e) {
                var t = e.toLowerCase(),
            ...
            function _() {
                ...
                return (
                    p.lookBehind
                        ? (p.startDate &&
                              L(e, p.startDate) < 0 &&
                              (e = H(Q(p.startDate).toDate())),
                          p.endDate &&
                              0 < L(e, p.endDate) &&
                              (e = Q(p.endDate).toDate()))
                        : (p.startDate &&
                              L(e, p.startDate) < 0 &&
                              (e = Q(p.startDate).toDate()),
                          p.endDate &&
                              0 < L(H(e), p.endDate) &&
                              (e = R(Q(p.endDate).toDate()))),
                    p.singleDate &&
                        (p.startDate &&
                            L(e, p.startDate) < 0 &&
                            (e = Q(p.startDate).toDate()),
            ...
            function G(e) {
                e || (e = _()),
                    p.lookBehind
                        ? (z(R(e), "month1"), z(e, "month2"))
                        : (z(e, "month1"), z(H(e), "month2")),
